...
public class Mahasiswa {
  ...
  public String Update_Mahasiswa(){
      ...
      try {
            ...
            else if (PENJURUSAN.equals("2") || PENJURUSAN.equalsIgnoreCase("Jaringan Komputer")) {
      ...
      try {
          ...
          PreparedStatement ps = connection.prepareStatement("insert into mahasiswa(NIM, Nama, id_penjurusan) value('" + NIM + "','" + NAMA + "','" + PENJURUSAN + "')");
            if (PENJURUSAN.equals("1") || PENJURUSAN.equalsIgnoreCase("Software")){
               ...
               pl.executeUpdate(); 
               return "/index.xhtml?faces-redirect=true";
            }else if (PENJURUSAN.equals("3") || PENJURUSAN.equalsIgnoreCase("Multimedia")){
               PreparedStatement pl = connection.prepareStatement("insert into mahasiswa(NIM, Nama, id_penjurusan) value('" + NIM + "','" + NAMA + "','3')");
               pl.executeUpdate();
               return "/index.xhtml?faces-redirect=true";
            }else if (PENJURUSAN.equals("4")|| PENJURUSAN.equalsIgnoreCase("Embedded")){
